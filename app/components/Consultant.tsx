  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 items-center py-8 bg-[var(--navy)]">

            {/* Section label */}
            <p className="text-center text-gl font-bold tracking-[0.2em] uppercase text-[var(--primary)] mb-6">
              {t(content.nav.consultants)}
            </p>

            {/* Photo placeholder */}
            <div className="mx-auto rounded-3xl overflow-hidden items-end justify-center">
              <Image src="/ceo.jpg" alt="Consultant photo" width={200} height={50} className="object-contain rounded-t-full">

              </Image>
              {/* Name badge at bottom */}
              <div className="relative w-full bg-[var(--surface-2)] backdrop-blur-sm px-5 py-4 border-t text-center border-[var(--border)]">
        ...
        {/* Right — content */}
          <div className="mx-auto px-6 lg:px-0 bg-white py-8 md:py-16">
            <motion.p
